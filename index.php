        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <div class="flex justify-center lg:w-0 lg:flex-1">
                    <a href="#" class="text-lg font-bold text-white">SmartShelf</a>
                </div>
                ...
                <div class="md:flex items-center justify-end md:flex-1 lg:w-0">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <a href="usermanagement/logout.php" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-100 hover:bg-gray-200 md:py-4 md:text-lg md:px-10">Logout</a>
                    <?php else: ?>
                        <a href="login.php" class="whitespace-nowrap text-base font-medium text-gray-200 hover:text-gray-100 px-4">Login</a>
                        <a href="register.php" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-100 hover:bg-gray-200 md:py-4 md:text-lg md:px-10">Register</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="relative bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://via.placeholder.com/600x400" alt="">
            </div>
        </div>
    </div>
